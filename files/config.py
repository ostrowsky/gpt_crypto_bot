...
# Replay- and shadow-confirmed replacement guard. A non-losing position is not
# rotated out for another candidate; losing positions remain replaceable.
AGENT_REPLACEMENT_BLOCK_NON_LOSING_ENABLED: bool = True
...
# Multi-day regime-start observation. This path is independent from BUY/SELL,
# portfolio, cooldown, and Top-Gainer admission. The maximum-period audit in
# docs/specs/regime-start-watch.md rejected Telegram promotion, so it stays off.
REGIME_START_SHADOW_ENABLED: bool = True
REGIME_START_TELEGRAM_ENABLED: bool = False
REGIME_START_PROFILE: str = "base_recovery_v1"
REGIME_START_SCAN_SEC: int = 3600
REGIME_START_4H_FETCH_LIMIT: int = 240
REGIME_START_1D_FETCH_LIMIT: int = 220
REGIME_START_DEDUP_4H_BARS: int = 42
REGIME_START_4H_SLOPE_MIN_PCT: float = 0.08
REGIME_START_4H_RSI_MIN: float = 50.0
REGIME_START_4H_RSI_MAX: float = 70.0
REGIME_START_4H_ADX_MIN: float = 18.0
REGIME_START_4H_VOL_X_MIN: float = 0.65
REGIME_START_4H_PRICE_EDGE_MAX_PCT: float = 3.0
REGIME_START_1D_RSI_MIN: float = 35.0
...
TOP_GAINER_CRITIC_CATCHUP_DAYS: int = 7
WATCHLIST_TOP_GAINER_GOAL_TELEGRAM_REPORTS_ENABLED: bool = False
RL_TRAIN_TELEGRAM_REPORTS_ENABLED: bool = False

# Replay-validated target-aligned ranking baseline. Forward shadow only: this
# collector cannot emit alerts, open positions, or change BUY/SELL ranking.
STATIC_TARGET_TOP50_SHADOW_ENABLED: bool = True
STATIC_TARGET_TOP50_SHADOW_START_DAY_LOCAL: str = "2026-08-22"
STATIC_TARGET_TOP50_SHADOW_TIMEZONE: str = "Europe/Budapest"
STATIC_TARGET_TOP50_SHADOW_OBSERVATION_HOUR_LOCAL: int = 12
STATIC_TARGET_TOP50_SHADOW_OBSERVATION_MINUTE_LOCAL: int = 15
STATIC_TARGET_TOP50_SHADOW_OBSERVATION_GRACE_MINUTES: int = 30
STATIC_TARGET_TOP50_SHADOW_TARGET_HOUR_LOCAL: int = 23
STATIC_TARGET_TOP50_SHADOW_LABEL_DELAY_MINUTES: int = 5
STATIC_TARGET_TOP50_SHADOW_TOP_N: int = 50
STATIC_TARGET_TOP50_SHADOW_SELECTION_SIZE: int = 10
STATIC_TARGET_TOP50_SHADOW_MIN_MARKET_SYMBOLS: int = 200
STATIC_TARGET_TOP50_SHADOW_MIN_WATCHLIST_SYMBOLS: int = 50
STATIC_TARGET_TOP50_SHADOW_CONCURRENCY: int = 8
STATIC_TARGET_TOP50_SHADOW_MIN_FORWARD_DAYS: int = 30
STATIC_TARGET_TOP50_SHADOW_MIN_OBSERVATION_COVERAGE: float = 0.90
STATIC_TARGET_TOP50_SHADOW_MIN_FINAL_COVERAGE: float = 0.85
...
V2_BTC_TREND_WATCH_TELEGRAM_ENABLED: bool = False
...
OBSERVABLE_TAIL_SHADOW_SELECTOR: str = "exclude_ema_and_false_cleanup"
OBSERVABLE_TAIL_SHADOW_MIN_PNL_PCT: float = -0.5
OBSERVABLE_TAIL_SHADOW_MIN_MFE_PCT: float = 1.0
