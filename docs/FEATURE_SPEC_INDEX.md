...
| Continuous improvement control plane | architecture v2.2; implementation not started | `docs/specs/continuous-improvement-control-plane.md` | power-feasible share, decision-grade terminal evidence, time/cost per terminal result, objective/guardrail truthfulness | implement the Phase -1 `FixtureDeltaValidatorAdapter` before Phase 0 or agent work |
