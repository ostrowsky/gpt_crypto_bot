...
| Objective leader admission replay | maximum-period complete; all three profiles rejected | `docs/specs/objective-leader-admission-replay.md` | early capture, lead time, precision, canonical alpha, drawdown | keep production unchanged; next work must rank simultaneous candidates rather than reserve idle capacity |
