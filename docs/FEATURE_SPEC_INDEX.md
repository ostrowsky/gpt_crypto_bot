...
| V2 hindsight lifecycle labeling | research-only planning | `docs/specs/v2-hindsight-lifecycle-labeling.md` | label balance, transition quality, leakage control | implement first labeling algorithm |
