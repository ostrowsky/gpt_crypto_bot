...
| Continuous improvement control plane | architecture v2.1; implementation not started | `docs/specs/continuous-improvement-control-plane.md` | verified terminal experiment rate, power-feasible yield, objective/guardrail truthfulness, loop liveness, cycle cost | implement the Phase -1 walking skeleton before Phase 0 registries/labels or agent autonomy |
